...
export const SKINS: SkinConfig[] = [
    ...
    { id: 'skin_crack_mask', nameZH: '裂面呼吸罩', slot: 'character', priceGold: 80000, rarity: 'R', visualOnly: true },
    { id: 'skin_blackrain', nameZH: '黑雨巡者', slot: 'character', priceGold: 250000, rarity: 'SR', visualOnly: true },
    // 武器外觀
    { id: 'skin_saw_pipe', nameZH: '鋸齒鐵管', slot: 'weapon', priceGold: 20000, rarity: 'C', visualOnly: true },
    { id: 'skin_char_saber', nameZH: '焦黑軍刀', slot: 'weapon', priceGold: 70000, rarity: 'R', visualOnly: true },
    { id: 'skin_bone_barrel', nameZH: '白骨槍殼', slot: 'weapon', priceGold: 180000, rarity: 'SR', visualOnly: true },
    // 寵物外觀
    { id: 'skin_can_drone', nameZH: '罐頭偵測機', slot: 'pet', priceGold: 50000, rarity: 'U', visualOnly: true },
    { id: 'skin_shell_buoy', nameZH: '破殼浮標', slot: 'pet', priceGold: 90000, rarity: 'R', visualOnly: true },
    { id: 'skin_soot_cart', nameZH: '煤煙小車', slot: 'pet', priceGold: 140000, rarity: 'SR', visualOnly: true },
    // HUD 主題
    ...
    { id: 'skin_black_box', nameZH: '黑匣介面', slot: 'hud', priceGold: 80000, rarity: 'R', visualOnly: true }
];
